...
#
# Begin "exemplo_Debug" configuration
#

ifeq ($(MAKECMDGOALS),exemplo_Debug)

exemplo_Debug : ./Debug/exemplo.dxe 

./Debug/dotprod.doj :dotprod.c 
	@echo ".\dotprod.c"
	$(VDSP)/ccblkfn.exe -c .\dotprod.c -file-attr ProjectName=exemplo -g -structs-do-not-overlap -no-multiline -double-size-32 -decls-strong -warn-protos -proc ADSP-BF533 -o .\Debug\dotprod.doj -MM
